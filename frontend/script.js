...
document.addEventListener("DOMContentLoaded", function () {
    var form = document.getElementById("markdownForm");
    ...
    form.onsubmit = function (event) { return __awaiter(_this, void 0, void 0, function () {
        var title, content, response, data, uniqueID, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch("http://localhost:8080/api/pastes", {
                            method: "POST",
                            headers: {
                ...
                case 3:
                    ...
                    pasteLink.href = "/paste/".concat(uniqueID);
